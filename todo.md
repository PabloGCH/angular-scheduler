- [x] Add spinner to table
- [x] Aake next/previous buttons reaload the table
- [x] Move buttons to dropdown on mobile
- [x] Give appointment popup.
- [x] Add form for make appointment.
- [x] Add appointment detail.
...
- [ ] Add extra validations to login.
